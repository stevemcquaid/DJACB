  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved rating as @rating" do
        ...
        post :create, {:rating => { "rating" => "invalid value" }}, valid_session
        expect(assigns(:rating)).to be_a_new(Rating)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rating" do
        ...
        expect_any_instance_of(Rating).to receive(:update_attributes).with({ "rating" => "1" })
        put :update, {:id => rating.to_param, :rating => { "rating" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the rating as @rating" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Rating.any_instance.stub(:save).and_return(false)
        put :update, {:id => rating.to_param, :rating => { "rating" => "invalid value" }}, valid_session
        expect(assigns(:rating)).to eq(rating)
      end
